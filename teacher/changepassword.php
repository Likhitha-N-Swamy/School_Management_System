...
$teacher_id = $_SESSION['user_id']; // Get teacher's ID from session

// Fetch the current user's information
$sql = "SELECT id, name, email, password FROM accounts WHERE id = $teacher_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_sql = "UPDATE accounts SET password = '$hashed_password' WHERE id = $teacher_id";
